...
:files="article.imageartpetitf" />
 ...
 <div class="form-group"><FilePond @change="onFileChangeM" :files="tab" @removefile
="onRemoveFileClick" />
</div>
...
export default {
 ...
 onFileChange(e) {this.article.imageartpetitf ='../storage/images/'+e.target.files[0].name;
